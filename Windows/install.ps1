...
function CheckForUpdates {
  try {
    ...
    if ($localVersion -lt $remoteVersion) {
      Write-Host -Fore Cyan "[!] A new version $remoteVersion is available on Github. Please upgrade your copy of Ceo-Forensics."
    }
    else {
...
if ($UPDATE) {
  ...
  #$source = 'https://raw.githubusercontent.com/ceotools/Ceo-Forensics/main/version.txt'
  ...
  if ((Get-FileHash $version_file).hash -eq (Get-FileHash $current_version).hash) {
    ...
    $source = 'https://github.com/ceotools/Ceo-Forensics/archive/refs/heads/main.zip'
    $destination = 'Ceo-Forensics-main.zip'
    Invoke-WebRequest -Uri $source -OutFile $destination
    Write-Host -Fore DarkCyan "[*] Extracting the downloads....."
    Expand-Archive -Force $PSScriptRoot\Updated\Ceo-Forensics-main.zip -DestinationPath $PSScriptRoot\Updated 
    Write-Host -Fore DarkCyan "[*] Cleaning Up...."
    Remove-Item -Path $PSScriptRoot\Updated\Ceo-Forensics-main.zip -Force
...
if ($DECRYPT) {
  ...
  if (!(Get-ChildItem $DecryptPath *.Ceo-Forensics)) { 
  ...
  Import-Module "$PSScriptRoot\Ceo-Forensics-Share\FileCryptography.psm1"

  $key = Read-Host -Prompt 'Enter Decryption Key'
  $Extension = ".Ceo-Forensics"
...
if ($USAGE) {
  ...
  Write-Host ''
  Write-Host -Fore DarkCyan   '[*] .\Ceo-Forensics.ps1   This runs the Basic checks on a system.'
  Write-Host ''
  ...
  Write-Host -Fore DarkCyan   ''
  Write-Host -Fore DarkCyan   '[*] .\Ceo-Forensics.ps1 -VERSION           This checks the version of Foresicator you have'
  Write-Host -Fore DarkCyan   '[*] .\Ceo-Forensics.ps1 -UPDATE            This checks for and updates your copy of Ceo-Forensics'
  Write-Host -Fore DarkCyan   '[*] .\Ceo-Forensics.ps1 -DECRYPT DECRYPT   This decrypts a Foresicator encrypted Artifact'
  Write-Host -Fore Cyan       "[!] requires the FileCryptography file in share folder"
  Write-Host -Fore DarkCyan   '[*] .\Ceo-Forensics.ps1 -USAGE             Prints this help file'
...
if (-not (Test-IsAdministrator)) {
  Write-Host -Fore DarkCyan "[!] Ceo-Forensics is not running with admin rights"
...
$Folder = 'Ceo-Forensics-Share'

if (Test-Path -Path $Folder) {
  #Write-Host -Fore Cyan "[!] You have the share folder moving on.."
}
else {
  Write-Host -Fore Cyan "[!] Ceo-Forensics-Share folder not found, some flags and functions will not work! use the -UPDATE flag to import the complete Arsenal.."
...
Write-Host ''
Write-Host ''
Write-Host -Fore DarkCyan   '[!] Live Ceo-Forensics'
Write-Host ''
...
Write-Host -Fore DarkCyan   '[!] https://github.com/ceotools/Ceo-Forensics'
...
$Ceo-ForensicsIndexFile = 'index.html'

# Setting Extras Output file
$Ceo-ForensicsExtrasFile = 'extras.html'
...
if ($RAM) {
  ...
  if ((gwmi win32_operatingsystem | Select-Object osarchitecture).osarchitecture -eq "64-bit") {
    ...
    & $PSScriptRoot\Ceo-Forensics-Share\winpmem_mini_x64_rc2.exe RAM\$env:computername.raw | Out-Null
    ...
    & $PSScriptRoot\Ceo-Forensics-Share\winpmem_mini_x86.exe RAM\$env:computername.raw | Out-Null
...
if ($BROWSER) {
  ...
  if ((gwmi win32_operatingsystem | Select-Object osarchitecture).osarchitecture -eq "64-bit") {
    ...
    & $PSScriptRoot\Ceo-Forensics-Share\BrowsingHistoryView64.exe /sverhtml "BrowserHistory.html" /SaveDirect /HistorySource 1 /VisitTimeFilterType 1 /LoadIE 1 /LoadFirefox 1 /LoadChrome 1 /LoadSafari 1

  }
  else {
    
    & $PSScriptRoot\Ceo-Forensics-Share\BrowsingHistoryView86.exe /sverhtml "BrowserHistory.html" /SaveDirect /HistorySource 1 /VisitTimeFilterType 1 /LoadIE 1 /LoadFirefox 1 /LoadChrome 1 /LoadSafari 1
...
$maliciousUrlsFilePath = "$PSScriptRoot\Ceo-Forensics-Share\malicious_URLs.txt"
...
function Process-ChromeHistory {
    ...
    $sqlitePath = "$PSScriptRoot\Ceo-Forensics-Share\sqlite3.exe"
...
if ($PCAP) {
  ...
  if ((gwmi win32_operatingsystem | Select-Object osarchitecture).osarchitecture -eq "64-bit") {
    ...
    & $PSScriptRoot\Ceo-Forensics-Share\etl2pcapng64.exe PCAP\$env:computername.et1 PCAP\$env:computername.pcap
	
  }
  else {
    
    & $PSScriptRoot\Ceo-Forensics-Share\etl2pcapng86.exe PCAP\$env:computername.et1 PCAP\$env:computername.pcap
...
if ($HASHCHECK) {
  ...
  $hashFilePath = "$PSScriptRoot\Ceo-Forensics-Share\md5hashes.txt"
  ...
  if (-Not (Test-Path $hashFilePath)) {
    Write-Host -Fore DarkCyan "[*] Hash file not found in Ceo-Forensics-Share"
...
Write-Host -Fore DarkCyan "[!] Hang on, the Ceo-Forensics is compiling your results"
...
<!-- Basic Page Info -->
<meta charset="utf-8" />
<title>Live Ceo-Forensics - Results for $env:computername</title>
...
href="https://cdn.jsdelivr.net/gh/ceotools/Ceo-Forensics@main/styles/vendors/styles/core.css"
onerror="this.onerror=null;this.href='../../styles/vendors/styles/core.css';" />
<link rel="stylesheet" type="text/css"
href="https://cdn.jsdelivr.net/gh/ceotools/Ceo-Forensics@main/styles/vendors/styles/icon-font.min.css"
onerror="this.onerror=null;this.href='../../styles/vendors/styles/icon-font.min.css';" />
<link rel="stylesheet" type="text/css"
href="https://cdn.jsdelivr.net/gh/ceotools/Ceo-Forensics@main/styles/src/plugins/datatables/css/dataTables.bootstrap4.min.css"
onerror="this.onerror=null;this.href='../../styles/src/plugins/datatables/css/dataTables.bootstrap4.min.css';" />
<link rel="stylesheet" type="text/css"
href="https://cdn.jsdelivr.net/gh/ceotools/Ceo-Forensics@main/styles/src/plugins/datatables/css/responsive.bootstrap4.min.css"
onerror="this.onerror=null;this.href='../../styles/src/plugins/datatables/css/responsive.bootstrap4.min.css';" />
<link rel="stylesheet" type="text/css"
href="https://cdn.jsdelivr.net/gh/ceotools/Ceo-Forensics@main/styles/vendors/styles/style.css"
...
<img src="https://cdn.jsdelivr.net/gh/ceotools/Ceo-Forensics@main/styles/vendors/images/Ceo-Forensics_logo.png" alt="" />
</div>
...
<a href="https://github.com/ceotools/Ceo-Forensics" target="_blank"><img src="https://cdn.jsdelivr.net/gh/ceotools/Ceo-Forensics@main/styles/vendors/images/github.svg"
alt="" /></a>
</div>
</div>
</div>
...
<a href="index.html">
<img src="https://cdn.jsdelivr.net/gh/ceotools/Ceo-Forensics@main/styles/vendors/images/Ceo-Forensics_logo.png" alt="" class="dark-logo" />
<img src="https://cdn.jsdelivr.net/gh/ceotools/Ceo-Forensics@main/styles/vendors/images/Ceo-Forensics_logo.png" alt="" class="light-logo" />
</a>
...
<span class="micon bi bi-router"></span><span class="mtext">Ceo-Forensics Extras</span>
</a>
</li>
</ul>
</div>
...
Live Ceo-Forensics script, we believe the contents will aid
...
Live Ceo-Forensics - Coded By
<a href="https://github.com/ceotools/Ceo-Forensics" target="_blank">The Black Widow</a>
</div>
</div>
</div>
<!-- js -->
<script type="text/javascript"
src="https://cdn.jsdelivr.net/gh/ceotools/Ceo-Forensics@main/styles/vendors/scripts/core.js"></script>
<script>window.jQuery || document.write('<script src="../../styles/vendors/scripts/core.js"><\/script>')</script>
<script type="text/javascript"
src="https://cdn.jsdelivr.net/gh/ceotools/Ceo-Forensics@main/styles/vendors/scripts/script.js"></script>
<script>window.jQuery || document.write('<script src="../../styles/vendors/scripts/script.js"><\/script>')</script>
<script type="text/javascript"
src="https://cdn.jsdelivr.net/gh/ceotools/Ceo-Forensics@main/styles/vendors/scripts/process.js"></script>
<script>window.jQuery || document.write('<script src="../../styles/vendors/scripts/process.js"><\/script>')</script>
<script type="text/javascript"
src="https://cdn.jsdelivr.net/gh/ceotools/Ceo-Forensics@main/styles/vendors/scripts/layout-settings.js"></script>
<script>window.jQuery || document.write('<script src="../../styles/vendors/scripts/layout-settings.js"><\/script>')</script>
<script type="text/javascript"
src="https://cdn.jsdelivr.net/gh/ceotools/Ceo-Forensics@main/styles/src/plugins/datatables/js/jquery.dataTables.min.js"></script>
<script>window.jQuery || document.write('<script src="../../styles/src/plugins/datatables/js/jquery.dataTables.min.js"><\/script>')</script>
<script
src="https://cdn.jsdelivr.net/gh/ceotools/Ceo-Forensics@main/styles/src/plugins/datatables/js/dataTables.bootstrap4.min.js"></script>
...
<script
src="https://cdn.jsdelivr.net/gh/ceotools/Ceo-Forensics@main/styles/src/plugins/datatables/js/dataTables.responsive.min.js"></script>
...
<script
src="https://cdn.jsdelivr.net/gh/ceotools/Ceo-Forensics@main/styles/src/plugins/datatables/js/responsive.bootstrap4.min.js"></script>
...
<script
src="https://cdn.jsdelivr.net/gh/ceotools/Ceo-Forensics@main/styles/src/plugins/datatables/js/dataTables.buttons.min.js"></script>
<script>window.jQuery || document.write('<script src="../../styles/src/plugins/datatablges/js/dataTables.buttons.min.js"><\/script>')</script>
<script
src="https://cdn.jsdelivr.net/gh/ceotools/Ceo-Forensics@main/styles/src/plugins/datatables/js/buttons.bootstrap4.min.js"></script>
<script>window.jQuery || document.write('<script src="../../styles/src/plugins/datatabgles/js/buttons.bootstrap4.min.js"><\/script>')</script>
<script
src="https://cdn.jsdelivr.net/gh/ceotools/Ceo-Forensics@main/styles/src/plugins/datatables/js/buttons.print.min.js"></script>
<script>window.jQuery || document.write('<script src="../../styles/src/plugins/datatabgles/js/buttons.print.min.js"><\/script>')</script>
<script
src="https://cdn.jsdelivr.net/gh/ceotools/Ceo-Forensics@main/styles/src/plugins/datatables/js/buttons.html5.min.js"></script>
<script>window.jQuery || document.write('<script src="../../styles/src/plugins/datatabgles/js/buttons.html5.min.js"><\/script>')</script>
<script
src="https://cdn.jsdelivr.net/gh/ceotools/Ceo-Forensics@main/styles/src/plugins/datatables/js/buttons.flash.min.js"></script>
<script>window.jQuery || document.write('<script src="../../styles/src/plugins/datatabgles/js/buttons.flash.min.js"><\/script>')</script>
<script
src="https://cdn.jsdelivr.net/gh/ceotools/Ceo-Forensics@main/styles/src/plugins/datatables/js/pdfmake.min.js"></script>
<script>window.jQuery || document.write('<script src="../../styles/src/plugins/datatabgles/js/pdfmake.min.js"><\/script>')</script>
<script
src="https://cdn.jsdelivr.net/gh/ceotools/Ceo-Forensics@main/styles/src/plugins/datatables/js/vfs_fonts.js"></script>
<script>window.jQuery || document.write('<script src="../../styles/src/plugins/datatabgles/js/vfs_fonts.js"><\/script>')</script>
<!-- Datatable Setting js -->
<script
src="https://cdn.jsdelivr.net/gh/ceotools/Ceo-Forensics@main/styles/vendors/scripts/datatable-setting.js"></script>
...
Ceo-ForensicsIndex | Out-File -FilePath $Ceo-ForensicsIndexFile
...
<head>
  <!-- Basic Page Info -->
  <meta charset="utf-8" />
  <title>Live Ceo-Forensics - Results for $Hostname</title>
  <!-- Mobile Specific Metas -->
  <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
  <!-- Google Font -->
  <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800&display=swap"
...
<body>
  <div class="pre-loader">
    <div class="pre-loader-box">
      <div class="loader-logo">
        <img
          src="https://cdn.jsdelivr.net/gh/ceotools/Ceo-Forensics@main/styles/vendors/images/Ceo-Forensics_logo.png"
          alt="../../styles/vendors/images/Ceo-Forensics_logo.png" />
      </div>
      <div class="loader-progress" id="progress_div">
        <div class="bar" id="bar1"></div>
      </div>
  ...
  <div class="header">
    ...
    <div class="header-right">
      ...
      <div class="github-link">
        <a href="https://github.com/ceotools/Ceo-Forensics" target="_blank"><img
            src="https://raw.githubusercontent.com/ceotools/Ceo-Forensics/43c2392ad8f54a9e387f9926b9d60e434dd545f2/styles/vendors/images/github.svg"
            alt="" /></a>
      </div>
    </div>
  </div>
    ...
    <div class="menu-block customscroll">
      <div class="sidebar-menu">
        <ul id="accordion-menu">
          ...
          <li class="dropdown">
            <a href="extras.html" class="dropdown-toggle no-arrow">
              <span class="micon bi bi-download"></span><span class="mtext">Ceo-Forensics Extras</span>
            </a>
          </li>
        </ul>
      </div>
...
# Call the function to generate the report
Ceo-ForensicsExtras | Out-File -FilePath $Ceo-ForensicsExtrasFile
